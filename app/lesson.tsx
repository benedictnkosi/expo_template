...
import { StyleSheet, Pressable, ActivityIndicator, ScrollView, View, Modal, Animated, Keyboard } from 'react-native';
...
function LessonContent() {
    ...
    useEffect(() => {
        async function fetchQuestions() {
            try {
                const url = `${HOST_URL}/api/language-questions/lesson/${lessonId}/language/${languageCode}`;
    ...
    return (
        <ThemedView style={styles.container}>
            ...
            {!showReview && !showCelebration && questions.length > 0 && currentQuestionIndex < questions.length && !isKeyboardVisible && (
