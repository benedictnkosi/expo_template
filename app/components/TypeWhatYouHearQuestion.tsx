...
export function TypeWhatYouHearQuestion({
    ...
    console.log('TypeWhatYouHearQuestion words:', words);
    console.log('TypeWhatYouHearQuestion options:', options);
    console.log('TypeWhatYouHearQuestion selectedLanguage:', selectedLanguage);
    console.log('TypeWhatYouHearQuestion questionId:', questionId);
